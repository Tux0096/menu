...
export const actions = {
  /** Самовывоз: выбор ресторана (каталог уже с фильтром стоп-листа по терминалу после выбора). */
  async showDeliveryModal({ dispatch, commit }) {
    await dispatch('cart/setDeliveryMethod', 'self', { root: true });
    commit('showRestaurantModal');
  },
};
