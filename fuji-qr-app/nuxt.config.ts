...
export default async (): Promise<NuxtConfig> => {
  ...
  return {
    ...
    publicRuntimeConfig: {
      ...
      /** true — после processCart дергать POST /api/v1/remarked-loyalty/order/update */
      FEATURE_REMARKED_LOYALTY: process.env.FEATURE_REMARKED_LOYALTY === 'true',
    },
    ...
    plugins: [
      ...
      { src: '~/plugins/app-metrica.js', mode: 'client' },
    ],
