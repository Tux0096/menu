    ...
    <div class="page-index">
      <portal to="header-slider">
        <AppSlider
          ...
          class="page-index__slider page-index__slider--mobile"
        >
          <swiper-slide
...
export default {
  ...
  async fetch() {
    ...
    slides.forEach((s) => {
      if (s.isMobile) {
        const imagePath = this.$img(s.path, { width: 600, quality: 70, format: 'webp' });
    ...
    this.preloadLinks = preloadLinks;
  },
  head() {
    return {
