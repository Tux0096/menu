...
export default ({ app }, inject) => {
   ...
   */
  const options = JSON.parse('{"id":"XXXXXXXX","webvisor":true,"clickmap":true,"useCDN":false,"trackLinks":true,"accurateTrackBounce":true,"debug":false,"noJS":false,"disabled":false,"ut":"noindex","ecommerce":"dataLayer"}');
  const { router } = app;
