...
export default ({ app }, inject) => {
  ...
  class WebSocketManager {
    ...
    handleMessage(event) {
      ...
      if (data.type === 'catalog:update') {
        console.log('[WebSocket] Обновление каталога:', data.data.hash);
        app.store.dispatch('catalog/initCatalog')
          .then(() => app.store.dispatch('cart/initCart'));
      }
